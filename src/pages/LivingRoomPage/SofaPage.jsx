...
const SofaPage = () => {
    ...
    const asccendingSortedAlphabet = [...sofaProducts].sort((a,b) => a.name > b.name ? 1 : -1)  
    const descendingSortedAlphabet = [...sofaProducts].sort((a,b) => a.name > b.name ? -1 : 1)
    const asccendingSortedPrice = [...sofaProducts].sort((a,b) => parseFloat(a.price) - parseFloat(b.price))
    const descendingSortedPrice = [...sofaProducts].sort((a,b) => parseFloat(b.price) - parseFloat(a.price))    
    ...
    useEffect(() => {
        switch (value) {
            ...
            case '2':
                setSofaProducts(asccendingSortedAlphabet)
                break;

            case '3':
                setSofaProducts(descendingSortedAlphabet)
                break;

            case '4':
                setSofaProducts(asccendingSortedPrice)
                break;

            case '5':
                setSofaProducts(descendingSortedPrice)
            break;
        ...
        <div className="products-wrap"> 
            ...
            <div className='livingroom-page'>
                <div className='products-wrap-text'>
                    <div className='products-text'>Sofa phòng khách</div>
                </div>
                <div className='underline'></div>
                <div className='cart-product-wrap'>
                    {
                        sofaProducts.filter(product => {
                            if(searchProducts == "") {
                                return product
